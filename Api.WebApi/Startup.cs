    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services
            .AddXafWebApi(Configuration, options => {
                options.BusinessObject<Accessaries>();
                options.BusinessObject<Bill>();
                options.BusinessObject<InWarehouse>();
                options.BusinessObject<OutWarehouse>();
                options.BusinessObject<Cars>();
                options.BusinessObject<Customers>();
                options.BusinessObject<Debt>();
                options.BusinessObject<Garas>();
                options.BusinessObject<CarService>(); 
